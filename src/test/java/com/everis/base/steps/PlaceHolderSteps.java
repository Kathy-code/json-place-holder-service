...
//    private Response response;
    ...
    @Step("imprime la cantidad de artículos existentes")
    public void getCantidadPosts() {


        System.out.println("----------SE ESTA OBTENIENDO LA CANTIDAD DE ARTICULOS-------------");
        System.out.printf("Cantidad de artículos: %s%n", response.getBody().asPrettyString().length());
